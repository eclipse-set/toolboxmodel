...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Bahnuebergang.BUE_Einschaltung_Zuordnung} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BUE_Einschaltung_ZuordnungItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDBUEGleisbezGefahrraumPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BUE_Einschaltung_Zuordnung_iDBUEEinschaltung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BUE_Einschaltung_Zuordnung_iDBUEEinschaltung_feature", "_UI_BUE_Einschaltung_Zuordnung_type"),
	...
	/**
	 * This adds a property descriptor for the IDBUE Gleisbez Gefahrraum feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDBUEGleisbezGefahrraumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BUE_Einschaltung_Zuordnung_iDBUEGleisbezGefahrraum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BUE_Einschaltung_Zuordnung_iDBUEGleisbezGefahrraum_feature", "_UI_BUE_Einschaltung_Zuordnung_type"),
