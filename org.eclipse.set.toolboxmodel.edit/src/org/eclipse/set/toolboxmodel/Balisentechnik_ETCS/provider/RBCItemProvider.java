...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Balisentechnik_ETCS.RBC} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RBC_iDESTWZentraleinheit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RBC_iDESTWZentraleinheit_feature", "_UI_RBC_type"),
	...
	protected void addIDUnterbringungPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RBC_iDUnterbringung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RBC_iDUnterbringung_feature", "_UI_RBC_type"),
