...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Fahrstrasse.Fstr_Abhaengigkeit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fstr_Abhaengigkeit_iDFstrFahrweg_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fstr_Abhaengigkeit_iDFstrFahrweg_feature", "_UI_Fstr_Abhaengigkeit_type"),
	...
	protected void addIDBedienAnzeigeElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fstr_Abhaengigkeit_iDBedienAnzeigeElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fstr_Abhaengigkeit_iDBedienAnzeigeElement_feature", "_UI_Fstr_Abhaengigkeit_type"),
