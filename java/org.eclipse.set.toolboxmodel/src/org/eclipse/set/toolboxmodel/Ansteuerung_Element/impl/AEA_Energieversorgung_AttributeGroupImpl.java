 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.toolboxmodel.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getEnergieversorgungArtErsatz <em>Energieversorgung Art Ersatz</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getIDEnergieSekundaer <em>ID Energie Sekundaer</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getEnergieversorgungArt <em>Energieversorgung Art</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Ansteuerung_Element.impl.AEA_Energieversorgung_AttributeGroupImpl#getIDEnergiePrimaer <em>ID Energie Primaer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AEA_Energieversorgung_AttributeGroupImpl extends MinimalEObjectImpl.Container implements AEA_Energieversorgung_AttributeGroup {
	...
	public void setIDEnergieSekundaer(Basis_Objekt newIDEnergieSekundaer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_SEKUNDAER, oldIDEnergieSekundaer, iDEnergieSekundaer, !oldIDEnergieSekundaerESet));
	}
	...
	public void unsetIDEnergieSekundaer() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_SEKUNDAER, oldIDEnergieSekundaer, null, oldIDEnergieSekundaerESet));
	}
	...
	public Basis_Objekt getIDEnergiePrimaer() {
		if (iDEnergiePrimaer != null && iDEnergiePrimaer.eIsProxy()) {
			...
			if (iDEnergiePrimaer != oldIDEnergiePrimaer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_PRIMAER, oldIDEnergiePrimaer, iDEnergiePrimaer));
			}
		}
	...
	public void setIDEnergiePrimaer(Basis_Objekt newIDEnergiePrimaer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_PRIMAER, oldIDEnergiePrimaer, iDEnergiePrimaer, !oldIDEnergiePrimaerESet));
	}
	...
	public void unsetIDEnergiePrimaer() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ansteuerung_ElementPackage.AEA_ENERGIEVERSORGUNG_ATTRIBUTE_GROUP__ID_ENERGIE_PRIMAER, oldIDEnergiePrimaer, null, oldIDEnergiePrimaerESet));
	}
