 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.toolboxmodel.Weichen_und_Gleissperren.impl.GZ_Freimeldung_R_AttributeGroupImpl#getElementLage <em>Element Lage</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Weichen_und_Gleissperren.impl.GZ_Freimeldung_R_AttributeGroupImpl#getIDElement <em>ID Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GZ_Freimeldung_R_AttributeGroupImpl extends MinimalEObjectImpl.Container implements GZ_Freimeldung_R_AttributeGroup {
	...
	public Basis_Objekt getIDElement() {
		if (iDElement != null && iDElement.eIsProxy()) {
			...
			if (iDElement != oldIDElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_RATTRIBUTE_GROUP__ID_ELEMENT, oldIDElement, iDElement));
			}
		}
		return iDElement;
	}
	...
	public void setIDElement(Basis_Objekt newIDElement) {
		...
		iDElementESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_RATTRIBUTE_GROUP__ID_ELEMENT, oldIDElement, iDElement, !oldIDElementESet));
	}
	...
	public void unsetIDElement() {
		...
		iDElementESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Weichen_und_GleissperrenPackage.GZ_FREIMELDUNG_RATTRIBUTE_GROUP__ID_ELEMENT, oldIDElement, null, oldIDElementESet));
	}
