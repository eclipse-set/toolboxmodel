 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.toolboxmodel.Balisentechnik_ETCS.impl.Bgrenze_Nach_Ohne_Bed_Einstieg_AttributeGroupImpl#getIDWElement <em>IDW Element</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Balisentechnik_ETCS.impl.Bgrenze_Nach_Ohne_Bed_Einstieg_AttributeGroupImpl#getWLage <em>WLage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Bgrenze_Nach_Ohne_Bed_Einstieg_AttributeGroupImpl extends MinimalEObjectImpl.Container implements Bgrenze_Nach_Ohne_Bed_Einstieg_AttributeGroup {
		...
		if (iDWElement != null && iDWElement.eIsProxy()) {
			...
			if (iDWElement != oldIDWElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Balisentechnik_ETCSPackage.BGRENZE_NACH_OHNE_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, oldIDWElement, iDWElement));
			}
		}
		return iDWElement;
	}
	...
	public void setIDWElement(W_Kr_Gsp_Element newIDWElement) {
		...
		iDWElementESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Balisentechnik_ETCSPackage.BGRENZE_NACH_OHNE_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, oldIDWElement, iDWElement, !oldIDWElementESet));
	}
	...
	public void unsetIDWElement() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Balisentechnik_ETCSPackage.BGRENZE_NACH_OHNE_BED_EINSTIEG_ATTRIBUTE_GROUP__IDW_ELEMENT, oldIDWElement, null, oldIDWElementESet));
	}
