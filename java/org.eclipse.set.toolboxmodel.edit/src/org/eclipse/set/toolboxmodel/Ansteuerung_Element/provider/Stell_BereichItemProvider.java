		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stell_Bereich_iDAussenelementansteuerung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stell_Bereich_iDAussenelementansteuerung_feature", "_UI_Stell_Bereich_type"),
