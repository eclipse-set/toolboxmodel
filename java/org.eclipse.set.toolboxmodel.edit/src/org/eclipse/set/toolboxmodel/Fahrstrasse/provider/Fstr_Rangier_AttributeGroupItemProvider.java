...
public class Fstr_Rangier_AttributeGroupItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDFMAAnlageRangierFreiPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the IDFMA Anlage Rangier Frei feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDFMAAnlageRangierFreiPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fstr_Rangier_AttributeGroup_iDFMAAnlageRangierFrei_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fstr_Rangier_AttributeGroup_iDFMAAnlageRangierFrei_feature", "_UI_Fstr_Rangier_AttributeGroup_type"),
