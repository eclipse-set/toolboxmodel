...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Balisentechnik_ETCS.LEU_Modul} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LEU_ModulItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDInformationEingangPropertyDescriptor(object);
			addIDLEUAnlagePropertyDescriptor(object);
			addIDLEUSchaltkastenPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the ID Information Eingang feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDInformationEingangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LEU_Modul_iDInformationEingang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LEU_Modul_iDInformationEingang_feature", "_UI_LEU_Modul_type"),
	...
	/**
	 * This adds a property descriptor for the IDLEU Anlage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDLEUAnlagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LEU_Modul_iDLEUAnlage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LEU_Modul_iDLEUAnlage_feature", "_UI_LEU_Modul_type"),
	...
	/**
	 * This adds a property descriptor for the IDLEU Schaltkasten feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDLEUSchaltkastenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LEU_Modul_iDLEUSchaltkasten_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LEU_Modul_iDLEUSchaltkasten_feature", "_UI_LEU_Modul_type"),
