...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Bedienung.Bedien_Anrueckabschnitt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Bedien_AnrueckabschnittItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDGleisAbschnittPositionPropertyDescriptor(object);
			addIDGleisAbschnittDarstellenPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the ID Gleis Abschnitt Position feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDGleisAbschnittPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bedien_Anrueckabschnitt_iDGleisAbschnittPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bedien_Anrueckabschnitt_iDGleisAbschnittPosition_feature", "_UI_Bedien_Anrueckabschnitt_type"),
	...
	/**
	 * This adds a property descriptor for the ID Gleis Abschnitt Darstellen feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDGleisAbschnittDarstellenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bedien_Anrueckabschnitt_iDGleisAbschnittDarstellen_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bedien_Anrueckabschnitt_iDGleisAbschnittDarstellen_feature", "_UI_Bedien_Anrueckabschnitt_type"),
