...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.ATO.ATO_Segment_Profile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ATO_Segment_ProfileItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDATOTSInstanzPropertyDescriptor(object);
			addIDATOTSInstanzNachbarPropertyDescriptor(object);
			addIDETCSKantePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the IDATOTS Instanz feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDATOTSInstanzPropertyDescriptor(Object object) {
	...
	/**
	 * This adds a property descriptor for the IDATOTS Instanz Nachbar feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDATOTSInstanzNachbarPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ATO_Segment_Profile_iDATOTSInstanzNachbar_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ATO_Segment_Profile_iDATOTSInstanzNachbar_feature", "_UI_ATO_Segment_Profile_type"),
	...
	/**
	 * This adds a property descriptor for the IDETCS Kante feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDETCSKantePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ATO_Segment_Profile_iDETCSKante_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ATO_Segment_Profile_iDETCSKante_feature", "_UI_ATO_Segment_Profile_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ATO_Segment_Profile_iDOertlichkeit_feature", "_UI_ATO_Segment_Profile_type"),
