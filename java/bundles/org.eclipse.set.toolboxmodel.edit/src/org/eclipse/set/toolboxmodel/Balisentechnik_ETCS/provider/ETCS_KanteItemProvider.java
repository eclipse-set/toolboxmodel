...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Balisentechnik_ETCS.ETCS_Kante} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ETCS_KanteItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDETCSKnotenAPropertyDescriptor(object);
			addIDETCSKnotenBPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the IDETCS Knoten A feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDETCSKnotenAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ETCS_Kante_iDETCSKnotenA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ETCS_Kante_iDETCSKnotenA_feature", "_UI_ETCS_Kante_type"),
	...
	/**
	 * This adds a property descriptor for the IDETCS Knoten B feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDETCSKnotenBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ETCS_Kante_iDETCSKnotenB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ETCS_Kante_iDETCSKnotenB_feature", "_UI_ETCS_Kante_type"),
	...
	protected void addIDRBCPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ETCS_Kante_iDRBC_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ETCS_Kante_iDRBC_feature", "_UI_ETCS_Kante_type"),
	...
	protected void addIDStreckePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ETCS_Kante_iDStrecke_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ETCS_Kante_iDStrecke_feature", "_UI_ETCS_Kante_type"),
	...
	protected void addIDTOPKantePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ETCS_Kante_iDTOPKante_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ETCS_Kante_iDTOPKante_feature", "_UI_ETCS_Kante_type"),
