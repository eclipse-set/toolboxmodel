...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Zugnummernmeldeanlage.ZN_Fortschalt_Kriterium} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ZN_Fortschalt_KriteriumItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDZNFortschaltKritStartPropertyDescriptor(object);
			addIDZNFortschaltKritZielPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZN_Fortschalt_Kriterium_iDZN_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZN_Fortschalt_Kriterium_iDZN_feature", "_UI_ZN_Fortschalt_Kriterium_type"),
	...
	/**
	 * This adds a property descriptor for the IDZN Fortschalt Krit Start feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDZNFortschaltKritStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZN_Fortschalt_Kriterium_iDZNFortschaltKritStart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZN_Fortschalt_Kriterium_iDZNFortschaltKritStart_feature", "_UI_ZN_Fortschalt_Kriterium_type"),
	...
	/**
	 * This adds a property descriptor for the IDZN Fortschalt Krit Ziel feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDZNFortschaltKritZielPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZN_Fortschalt_Kriterium_iDZNFortschaltKritZiel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZN_Fortschalt_Kriterium_iDZNFortschaltKritZiel_feature", "_UI_ZN_Fortschalt_Kriterium_type"),
