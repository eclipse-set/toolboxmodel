...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Ortung.FMA_Anlage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FMA_AnlageItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDGleisfreimeldeInnenanlagePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FMA_Anlage_iDGleisAbschnitt_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FMA_Anlage_iDGleisAbschnitt_feature", "_UI_FMA_Anlage_type"),
	...
	/**
	 * This adds a property descriptor for the ID Gleisfreimelde Innenanlage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDGleisfreimeldeInnenanlagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FMA_Anlage_iDGleisfreimeldeInnenanlage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FMA_Anlage_iDGleisfreimeldeInnenanlage_feature", "_UI_FMA_Anlage_type"),
