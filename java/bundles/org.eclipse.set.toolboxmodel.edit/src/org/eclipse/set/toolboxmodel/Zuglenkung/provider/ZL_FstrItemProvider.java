...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Zuglenkung.ZL_Fstr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ZL_FstrItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDZLPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZL_Fstr_iDFstrZugRangier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZL_Fstr_iDFstrZugRangier_feature", "_UI_ZL_Fstr_type"),
	...
	/**
	 * This adds a property descriptor for the IDZL feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDZLPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZL_Fstr_iDZL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZL_Fstr_iDZL_feature", "_UI_ZL_Fstr_type"),
	...
	protected void addIDZLFstrPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ZL_Fstr_iDZLFstr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ZL_Fstr_iDZLFstr_feature", "_UI_ZL_Fstr_type"),
