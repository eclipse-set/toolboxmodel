		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Punkt_Objekt_Strecke_AttributeGroup_iDStrecke_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Punkt_Objekt_Strecke_AttributeGroup_iDStrecke_feature", "_UI_Punkt_Objekt_Strecke_AttributeGroup_type"),
