...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Nahbedienbereich.NB_Zone} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NB_ZoneItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDNBPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the IDNB feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDNBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NB_Zone_iDNB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NB_Zone_iDNB_feature", "_UI_NB_Zone_type"),
	...
	protected void addIDNBZonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NB_Zone_iDNBZone_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NB_Zone_iDNBZone_feature", "_UI_NB_Zone_type"),
