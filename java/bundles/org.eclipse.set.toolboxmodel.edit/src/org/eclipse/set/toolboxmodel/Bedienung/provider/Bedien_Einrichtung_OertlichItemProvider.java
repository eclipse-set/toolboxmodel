...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Bedienung.Bedien_Einrichtung_Oertlich} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Bedien_Einrichtung_OertlichItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDAnhangBenutzeroberflaechePropertyDescriptor(object);
			addIDAussenelementansteuerungPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the ID Anhang Benutzeroberflaeche feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDAnhangBenutzeroberflaechePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bedien_Einrichtung_Oertlich_iDAnhangBenutzeroberflaeche_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bedien_Einrichtung_Oertlich_iDAnhangBenutzeroberflaeche_feature", "_UI_Bedien_Einrichtung_Oertlich_type"),
	...
	/**
	 * This adds a property descriptor for the ID Aussenelementansteuerung feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDAussenelementansteuerungPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bedien_Einrichtung_Oertlich_iDAussenelementansteuerung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bedien_Einrichtung_Oertlich_iDAussenelementansteuerung_feature", "_UI_Bedien_Einrichtung_Oertlich_type"),
	...
	protected void addIDUnterbringungPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bedien_Einrichtung_Oertlich_iDUnterbringung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bedien_Einrichtung_Oertlich_iDUnterbringung_feature", "_UI_Bedien_Einrichtung_Oertlich_type"),
