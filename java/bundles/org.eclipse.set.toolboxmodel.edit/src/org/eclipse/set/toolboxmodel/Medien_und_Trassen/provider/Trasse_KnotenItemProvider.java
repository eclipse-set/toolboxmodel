...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Medien_und_Trassen.Trasse_Knoten} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Trasse_KnotenItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDAnschlussElementPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the ID Anschluss Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDAnschlussElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trasse_Knoten_iDAnschlussElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trasse_Knoten_iDAnschlussElement_feature", "_UI_Trasse_Knoten_type"),
	...
	protected void addIDGEOKnotenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trasse_Knoten_iDGEOKnoten_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trasse_Knoten_iDGEOKnoten_feature", "_UI_Trasse_Knoten_type"),
