...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Weichen_und_Gleissperren.W_Kr_Gsp_Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_W_Kr_Gsp_Element_iDRegelzeichnung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_W_Kr_Gsp_Element_iDRegelzeichnung_feature", "_UI_W_Kr_Gsp_Element_type"),
	...
	protected void addIDStellelementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_W_Kr_Gsp_Element_iDStellelement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_W_Kr_Gsp_Element_iDStellelement_feature", "_UI_W_Kr_Gsp_Element_type"),
	...
	protected void addIDWKrAnlagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_W_Kr_Gsp_Element_iDWKrAnlage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_W_Kr_Gsp_Element_iDWKrAnlage_feature", "_UI_W_Kr_Gsp_Element_type"),
	...
	protected void addIDWeichenlaufkettePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_W_Kr_Gsp_Element_iDWeichenlaufkette_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_W_Kr_Gsp_Element_iDWeichenlaufkette_feature", "_UI_W_Kr_Gsp_Element_type"),
