...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.toolboxmodel.Flankenschutz.Fla_Freimelde_Zuordnung} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Fla_Freimelde_ZuordnungItemProvider extends Basis_ObjektItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIDFMAAnlagePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fla_Freimelde_Zuordnung_iDFlaSchutz_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fla_Freimelde_Zuordnung_iDFlaSchutz_feature", "_UI_Fla_Freimelde_Zuordnung_type"),
	...
	/**
	 * This adds a property descriptor for the IDFMA Anlage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIDFMAAnlagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fla_Freimelde_Zuordnung_iDFMAAnlage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fla_Freimelde_Zuordnung_iDFMAAnlage_feature", "_UI_Fla_Freimelde_Zuordnung_type"),
