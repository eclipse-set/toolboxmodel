 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.toolboxmodel.Nahbedienbereich.impl.NB_Zone_ElementImpl#getIDNBElement <em>IDNB Element</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Nahbedienbereich.impl.NB_Zone_ElementImpl#getIDNBZone <em>IDNB Zone</em>}</li>
 *   <li>{@link org.eclipse.set.toolboxmodel.Nahbedienbereich.impl.NB_Zone_ElementImpl#getNBZoneElementAllg <em>NB Zone Element Allg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NB_Zone_ElementImpl extends Basis_ObjektImpl implements NB_Zone_Element {
		...
		if (iDNBElement != null && iDNBElement.eIsProxy()) {
			...
			if (iDNBElement != oldIDNBElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, oldIDNBElement, iDNBElement));
			}
		}
		return iDNBElement;
	}
	...
	public void setIDNBElement(Basis_Objekt newIDNBElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, oldIDNBElement, iDNBElement, !oldIDNBElementESet));
	}
	...
	public void unsetIDNBElement() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ELEMENT, oldIDNBElement, null, oldIDNBElementESet));
	}
	...
	public NB_Zone getIDNBZone() {
		if (iDNBZone != null && iDNBZone.eIsProxy()) {
			...
			if (iDNBZone != oldIDNBZone) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, oldIDNBZone, iDNBZone));
			}
		}
		return iDNBZone;
	}
	...
	public void setIDNBZone(NB_Zone newIDNBZone) {
		...
		iDNBZoneESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, oldIDNBZone, iDNBZone, !oldIDNBZoneESet));
	}
	...
	public void unsetIDNBZone() {
		...
		iDNBZoneESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NahbedienbereichPackage.NB_ZONE_ELEMENT__IDNB_ZONE, oldIDNBZone, null, oldIDNBZoneESet));
	}
